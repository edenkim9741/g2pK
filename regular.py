...
def link1(inps, descriptive=False, verbose=False):
...
def link2(inps, descriptive=False, verbose=False):
...
def link3(inps, descriptive=False, verbose=False):
...
def link4(inps, descriptive=False, verbose=False):
