...
############################ vowels ############################
def jyeo(strings_by_idx, descriptive=False, verbose=False):
...
def ye(strings_by_idx, descriptive=False, verbose=False):
...
def consonant_ui(strings_by_idx, descriptive=False, verbose=False):
...
def josa_ui(strings_by_idx, descriptive=False, verbose=False):
...
def vowel_ui(strings_by_idx, descriptive=False, verbose=False):
...
def jamo(strings_by_idx, descriptive=False, verbose=False):
    ...
    ############################ 어간 받침 ############################
def rieulgiyeok(strings_by_idx, descriptive=False, verbose=False):
...
def rieulbieub(strings_by_idx, descriptive=False, verbose=False):
...
def verb_nieun(strings_by_idx, descriptive=False, verbose=False):
...
def balb(strings_by_idx, descriptive=False, verbose=False):
...
def palatalize(strings_by_idx, descriptive=False, verbose=False):
...
def modifying_rieul(strings_by_idx, descriptive=False, verbose=False):
